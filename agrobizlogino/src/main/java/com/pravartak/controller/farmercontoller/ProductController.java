...
public class ProductController {
        ...
        public List<Product> searchAllProducts(
                ...
                for (Product product : allProducts) {
                        ...
                        boolean matches = product.getProductName() != null &&
                        ...
                        if (!matches &&
                                ...
                                matches = product.getDescription()
                                                .toLowerCase()
                                                .contains(search);
                        }
