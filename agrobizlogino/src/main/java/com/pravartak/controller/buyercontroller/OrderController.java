...
public class OrderController {
        ...
        public boolean createOrder(
                ...
                try {
                        ...
                        Map<Integer, List<CartItem>> farmerItems = new HashMap<>();
                        ...
                        for (Map.Entry<Integer, List<CartItem>> entry : farmerItems.entrySet()) {
                                ...
                                for (CartItem cartItem : items) {
                                        ...
                                        double itemTotal = cartItem.getTotal();
        ...
        public Order getOrder(
                ...
                try {
                        ...
                        var document = db.collection("orders")
                                        .document(orderId)
                                        .get()
                                        .get();
