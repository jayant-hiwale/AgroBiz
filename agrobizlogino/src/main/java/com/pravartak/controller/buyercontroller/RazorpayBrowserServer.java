...
public class RazorpayBrowserServer {
        ...
        private String createPaymentHtml() {
                ...
                String safeName = escapeJavaScript(
                                buyerName);

                String safeEmail = escapeJavaScript(
                                buyerEmail);
        ...
        private void handlePaymentSuccess(
                ...
                String paymentId = data.get(
                                "razorpay_payment_id");

                String receivedOrderId = data.get(
                                "razorpay_order_id");

                String signature = data.get(
                                "razorpay_signature");

                boolean verified = receivedOrderId != null
