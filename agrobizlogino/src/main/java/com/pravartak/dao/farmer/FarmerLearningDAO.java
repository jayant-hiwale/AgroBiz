...
public class FarmerLearningDAO {
        ...
        public boolean addCourse(
                ...
                try {
                        ...
                        DocumentReference document = getFarmerCoursesCollection(farmerId)
                                        .document(
        ...
        public boolean isCourseAdded(
                ...
                try {
                        ...
                        DocumentSnapshot snapshot = getFarmerCoursesCollection(farmerId)
                                        .document(
                                                        String.valueOf(courseId))
                                        .get()
                                        .get();
        ...
        public List<Integer> getMyLearningCourseIds(
                ...
                try {
                        ...
                        List<QueryDocumentSnapshot> documents = getFarmerCoursesCollection(farmerId)
                                        .get()
                                        .get()
                                        .getDocuments();
        ...
        public List<Course> getMyLearningCourses(
                ...
                try {
                        ...
                        List<Integer> courseIds = getMyLearningCourseIds(
                                        farmerId);

                        FirebaseCourseDAO courseDAO = new FirebaseCourseDAO();
        ...
        public List<LearningActivity> getMyLearningActivities(
                        int farmerId) {
                ...
                try {
                        ...
                        for (QueryDocumentSnapshot document : documents) {
                                ...
                                Timestamp addedAt = document.getTimestamp(
                                                "addedAt");
