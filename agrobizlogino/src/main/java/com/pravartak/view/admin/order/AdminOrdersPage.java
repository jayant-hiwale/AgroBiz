...
public class AdminOrdersPage {
        ...
        private HBox createStatsCards() {
                ...
                deliveredLabel = new Label("0");

                cancelledLabel = new Label("0");
        ...
        private HBox createFilterBar() {
                ...
                searchField.textProperty()
                                .addListener(
                                                (obs, oldValue, newValue) -> loadOrders());
                ...
                try {
                        ...
                        for (Order order : orders) {
                                ...
                                if (!search.isEmpty()) {
                                        ...
                                        String orderId = safe(order.getOrderId()).toLowerCase();

                                        String buyer = safe(order.getBuyerName()).toLowerCase();

                                        String farmer = safe(order.getFarmerName()).toLowerCase();
        ...
        private VBox createOrderCard(
                ...
                if (order.getItems() != null) {
                        ...
                        for (Map<String, Object> item : order.getItems()) {
                                ...
                                Object itemTotalObject = item.get("itemTotal");

                                double itemTotal = 0;

                                if (itemTotalObject instanceof Number) {
                                        itemTotal = ((Number) itemTotalObject)
                                                        .doubleValue();
                                }
                ...
                if (order.getOrderStatus() != null
                        ...
                        updateButton.setOnAction(e -> {
                                ...
                                boolean success = controller.updateOrderStatus(
                                                order.getOrderId(),
                                                newStatus);
        ...
        private void showOrderDetails(
                ...
                Label itemsTitle = new Label("Products");
