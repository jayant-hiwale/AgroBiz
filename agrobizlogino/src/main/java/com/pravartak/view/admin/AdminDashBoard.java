...
public class AdminDashBoard extends BorderPane {
        ...
        private final Label statusLabel = new Label("Loading dashboard...");

        // CHART CONTAINERS

        private final PieChart userPieChart = new PieChart();

        private final BarChart<String, Number> productCategoryChart = createBarChart(
                        "Product Category",
                        "Products");

        private final BarChart<String, Number> courseCategoryChart = createBarChart(
                        "Course Category",
                        "Courses");

        private final BarChart<String, Number> communityLikesChart = createBarChart(
                        "Community Posts",
                        "Likes");
        ...
        private void createLayout() {
                ...
                HBox firstChartRow = new HBox(18);

                firstChartRow.setAlignment(
                                Pos.CENTER);

                VBox userDistributionCard = createChartCard(
                                "User Distribution",
                                "Farmers vs buyers",
                                userPieChart);

                VBox productCategoryCard = createChartCard(
                                "Marketplace",
        ...
        private GridPane createStatsGrid() {
                ...
                VBox pendingOrders = createStatCard(
                                "Pending Orders  ",
                                pendingOrdersValue,
                                "Awaiting action",
                                "⏳",
        ...
        private void loadDashboardData() {
                ...
                Task<DashboardData> task = new Task<>() {
                        ...
                        protected DashboardData call()
                                ...
                                List<User> farmers = userController.getFarmers();

                                List<User> buyers = userController.getBuyers();
                                ...
                                List<Course> courses = courseController
                                                .getAllCourses();
                                ...
                                List<CommunityPost> posts = communityController
                                                .getPosts();
        ...
        private void updateDashboard(
                ...
                Platform.runLater(() -> {
                        ...
                        long pendingOrders = data.orders.stream()
                                        .filter(order -> "PENDING".equalsIgnoreCase(
        ...
        // Change ONLY the pie chart words
        Platform.runLater(() -> {
                ...
                for (Node node :
                                userPieChart.lookupAll(".chart-pie-label")) {
        ...
        private void updateCommunityLikes(
                ...
                List<CommunityPost> sortedPosts = new java.util.ArrayList<>(
                                posts);
                ...
                for (int i = 0; i < limit; i++) {
                        ...
                        CommunityPost post = sortedPosts.get(i);

                        String name = post.getFarmerName();
