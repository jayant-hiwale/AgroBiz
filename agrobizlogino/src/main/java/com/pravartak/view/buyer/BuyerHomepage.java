...
public class BuyerHomepage {
        ...
        public Scene getBuyerHomePage() {
                ...
                String defaultSearchStyle = "-fx-background-color:rgba(255,255,255,0.85);" +
                ...
                Button viewMarketButton = new Button(
                                "Explore Fresh Market  🌾");

                String buttonBaseStyle = "-fx-background-color:" +
                ...
                Label livestock = createCategoryCard(
                                "🐄\nLivestock",
                                "Livestock");
        ...
        private Label createCategoryCard(
                ...
                String normalStyle = "-fx-background-color:" +
