...
public class FarmerOrdersPage {
        ...
        private VBox createOrderCard(
                ...
                VBox buyerBox = new VBox(7);

                Label buyerHeading = new Label(
                                "Buyer Information");
                ...
                Label buyerName = new Label(
                                "👤 "
                                                + safe(
                                                                order.getBuyerName()));

                Label buyerPhone = new Label(
                                "📞 "
                                                + safe(
                                                                order.getBuyerPhone()));

                Label buyerAddress = new Label(
                                "📍 "
                                                + safe(
        ...
        private void addStatusButtons(
                ...
                if ("ACCEPTED".equalsIgnoreCase(
                        ...
                        Button processing = createGreenButton(
                                        "⚙ Mark Processing");
                ...
                // =================================================
                        ...
                        Button delivery = createGreenButton(
                                        "🚚 Out for Delivery");
                ...
                else if ("OUT_FOR_DELIVERY".equalsIgnoreCase(
                                status)) {

                        Button delivered = createGreenButton(
                                        "✓ Mark Delivered");
                ...
                confirmation
                                ...
                                .ifPresent(response -> {
                                        ...
                                        try {
                                                ...
                                                boolean updated = orderController
                                                                .updateOrderStatus(
                                                                                order.getOrderId(),
                                                                                newStatus);
