...
public class FarmerDashboardHome {
        ...
        private static final Color BACKGROUND = Color.web("#050B0A");

        private static final Color DARK_GREEN = Color.web("#122a1d");

        private static final Color CARD_BACKGROUND = Color.web("#0D1213");

        private static final Color SECONDARY_CARD = Color.web("#050B0A");

        private static final Color GREEN = Color.web("#7ED957");

        private static final Color LIGHT_GREEN = Color.web("#1B3B25");

        private static final Color TEXT = Color.web("#F3F8F3");

        private static final Color GREY = Color.web("#A9B8AC");

        private static final Color MUTED = Color.web("#788A7D");

        private static final Color BORDER = Color.web("#294734");
        ...
        public FarmerDashboardHome(
                ...
                this.farmerName = (farmerName == null ||
                ...
                this.farmerLearningDAO = new FarmerLearningDAO();
        ...
        public VBox getDashboardHome() {
                ...
                int learningCount = getLearningCount();

                int schemesCount = SavedSchemesManager.getCount();
        ...
        private VBox createRecentActivity() {
                ...
                try {
                        ...
                        List<FarmerLearningDAO.LearningActivity> learningActivities = farmerLearningDAO
                                        .getMyLearningActivities(
                                                        farmerId);

                        if (learningActivities != null) {

                                for (FarmerLearningDAO.LearningActivity learningActivity : learningActivities) {
                                        ...
                                        Course course = learningActivity
                                                        .getCourse();
                ...
                try {
                        ...
                        List<SavedSchemesManager.SavedScheme> savedSchemes = SavedSchemesManager
                                        .getSavedSchemes();

                        if (savedSchemes != null) {

                                for (SavedSchemesManager.SavedScheme savedScheme : savedSchemes) {
                ...
                if (activities.isEmpty()) {
                        ...
                        Label emptyDescription = new Label(
        ...
        private VBox createQuickActions() {
                ...
                Button schemes = createQuickAction(
                                "🌱",
                                "Government Schemes",
                ...
                Button learning = createQuickAction(
                                "📚",
                                "Learning",
                ...
                Button products = createQuickAction(
                                "📦",
                                "My Products",
        ...
        private int getLearningCount() {
                ...
                try {
                        ...
                        List<Course> courses = farmerLearningDAO
        ...
        private int getTotalOrders() {
                ...
                try {
                        ...
                        List<Order> orders = orderController.getFarmerOrders(
                                        farmerId);
