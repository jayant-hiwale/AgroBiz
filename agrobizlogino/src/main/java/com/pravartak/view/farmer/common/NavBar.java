...
// //             MarketPlace marketPlaceScene = new MarketPlace(farmerId);
...
// //             FarmerDashboard fm = new FarmerDashboard(farmerId);
...
//     public NavBar(int farmerId, String firebaseUid) {
