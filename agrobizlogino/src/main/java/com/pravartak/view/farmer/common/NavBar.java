...
//         HBox right = new HBox(15,notification,profile,login);
...
public class NavBar {
    ...
    public HBox createNavbar(String currentPage) {
        ...
        community.setOnAction(e -> {
            ...
            CommunityPage communityPageScene = new CommunityPage();
            LoginPage.mainStage.setScene(communityPageScene.getCommunityScene());
        });
        ...
        profile.setOnAction(e -> {
         FarmerDashboard farmerDashboard = new FarmerDashboard(null);
         LoginPage.mainStage.setScene(farmerDashboard.getDashboardScene());
});
